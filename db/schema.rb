...
ActiveRecord::Schema.define(version: 2020_10_09_115219) do
  ...
  create_table "training_menus", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["record_id"], name: "index_training_menus_on_record_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "user_name"
    t.string "image"
    t.boolean "bodyweights_is_released", default: true, null: false
    t.boolean "records_is_released", default: true, null: false
